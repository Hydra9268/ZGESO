...
'Travel to _Khenarthi's Roost_ Wayshrine |q Storm on the Horizon/Investigate Shattered Shoals
|tip Manually skip to the next step.
step
...
step
'Open Auridon Map
'Travel to _Tanzelwil_ Wayshrine |q To Tanzelwil/Find the Queen's Entourage at Tanzelwil
|tip Manually skip to the next step.
|only Aldmeri Dominion
step
...
step
'Open Auridon Map
'Travel to _Skywatch_ Wayshrine |q To Dawnbreak/Talk to Canonreeve Sinyon in Dawnbreak
|tip Manually skip to the next step.
|only Aldmeri Dominion
step
...
'Travel to _Quendeluum_ Wayshrine |q To Firsthold/Report to a First Auridon Marine at Firsthold
|tip Manually skip to the next step.
step
...
step
'Open Auridon Map
'Travel to _Skywatch_ Wayshrine |q The Great Tree/Talk to Captain Jimila in Skywatch
|tip Manually skip to the next step.
step
...
|only Aldmeri Dominion
step
goto vulkhelguard_base 87.40,59.30 |q Chasing Shadows/Investigate Vulkhel Guard
|only Aldmeri Dominion
step
goto 67.32,61.07
...
goto 29.74,80.79
|tip Keep your distance and watch the dialogue.
|tip Standing Go upstairs in a side room on the boat.
...
step
goto 61.89,39.63
'Use _Elden Root Temple_ Wayshrine
'Travel to _Haven_ Wayshrine |q The Great Tree/Talk to King Camoran Aeradan in Elden Root
|tip Manually skip to the next step.
step
...
step
'Open Grahtwood Map
'Travel to _Elden Root_ Wayshrine |q The Honor of the Queen/Go to the Altmer Embassy
|tip Manually skip to the next step.
step
...
step
'Open Grahtwood Map
'Travel to _Elden Root Temple_ Wayshrine |q Lost in Study |future
|tip Manually skip to the next step.
step
...
step
'Open Grahtwood Map
'Travel to _Haven_ Wayshrine |q The Grip of Madness |future
|tip Manually skip to the next step.
step
...
step
'Open Grahtwood Map
'Travel to _Elden Root Temple_ Wayshrine |q A Lasting Winter |future
|tip Manually skip to the next step.
step
...
'Travel to _Gil-Var-Delle_ Wayshrine |q A Lasting Winter |future
|tip Manually skip to the next step.
step
...
step
goto 40.42,58.28
'Use _Falinesti Winter_ Wayshrine
'Travel to _Elden Root_ Wayshrine |q Fit to Rule/Talk to Meleras
|tip Manually skip to the next step.
step
...
step
'Open Grahtwood Map
'Travel to _Redfur Trading Post_ Wayshrine |q The Staff of Magnus/Find Captain Sarandil
|tip Manually skip to the next step.
step
...
talk Razum-dar |q Veil of Illusion/Talk to Razum-dar
step
goto 50.90,49.71 |q Veil of Illusion/Enter the Imperial Underground |tip Go back Go downstairs. and leave building.
step
goto 40.08,60.69
...
step
'Open Greenshade Map
'Travel to _Verrant Morass_ Wayshrine |q Shades of Green/Travel to Hectahame
|tip Manually skip to the next step.
step
goto 48.40,29.55
...
'Travel to _Dra'bul_ Wayshrine |q The Hound's Plan/Find the Silvenar in Jathsogur
|tip Manually skip to the next step.
step
...
|only Aldmeri Dominion
step
goto 60.30,38.49 |q A Wedding to Attend/Go to Silvenar
step
...
'Travel to _Fort Grimwatch_ Wayshrine |q Hallowed To Arenthia/Talk to Cariel in Arenthia
|tip Manually skip to the next step.
step
...
'Travel to _Dune_ Wayshrine |q The Fires of Dune/Find the Champion
|tip Manually skip to the next step.
step
...
'Travel to _Port Hunding_ Wayshrine |q The Spearhead's Crew |future
|tip Manually skip to the next step.
step
...
'Travel to _The Harborage_ in Glenumbra |q Daughter of Giants/Go to the Harborage |future
|tip Manually skip to the next step.
|only Daggerfall Covenant
step
...
step
'Open Glenumbra Map
'Travel to _Wyrd Tree_ Wayshrine |q Werewolves to the North/Talk to Chamberlain Weller
|tip Manually skip to the next step.
|only Daggerfall Covenant
step
...
step
'Open Glenumbra Map
'Travel to _Eagle's Brook_ Wayshrine |q Rally Cry/Talk to General Gautier
|tip Manually skip to the next step.
|only Daggerfall Covenant
step
goto 53.43,38.55
...
step
'Open Glenumbra Map
'Travel to _Eagle's Brook_ Wayshrine |q Taking the Fight to the Enemy/Seek Out the Lion Guard Redoubt Camp
|tip Manually skip to the next step.
step
...
|only Daggerfall Covenant
step
goto 61.01,20.77 |q Mists of Corruption/Find Knights in Cath Bedraud
step
...
'Travel to _Burial Tombs_ Wayshrine |q A Dangerous Dream/Find the Guard Captain
|tip Manually skip to the next step.
|only Daggerfall Covenant
step
goto 60.48,25.14
'Use _Lion Guard Redoubt_ Wayshrine
'Travel to _Burial Tombs_ Wayshrine |q A Dangerous Dream/Find the Guard Captain
|tip Manually skip to the next step.
...
step
goto 30.53,29.84 |q Unanswered Questions/Talk to Muran at Pariah Abbey |tip Leave the building.
step
...
'Travel to _Firebrand Keep_ Wayshrine |q Unanswered Questions/Talk to Muran at Pariah Abbey
|tip Manually skip to the next step.
|only not Daggerfall Covenant
step
goto 32.32,47.10
...
step
goto 47.39,37.67
'Use Healing Poultice |q Injured Spirit Wardens/.*Use the Healing Poultices on the Injured.* |count 3
step
goto 47.21,39.05
|tip Drop down under the bridge.
'Use Healing Poultice |q Injured Spirit Wardens/.*Use the Healing Poultices on the Injured.* |count 4
step
goto 43.13,37.12
talk Sister Safia
...
step
goto 50.51,41.67 |q Pursuing the Shard/Talk to High King Emeric |tip Leave this building.
step
goto 55.35,37.64
lorebook Ebony Blade History/1/16/3
|only Daggerfall Covenant
...
step
goto 45.99,43.70 |lorebook Monomyth: Lorkhan and Satakal/1/10/4
|only Daggerfall Covenant
step
goto 61.04,29.73
...
'Travel to _Wayrest_ Wayshrine |q Another Omen/Talk to High King Emeric in Wayrest
|tip Manually skip to the next step.
step
...
step
goto 48.62,11.41
|tip Go upstairs inside the Cloudy Dregs Inn.
lorebook The All-Beneficent King Fahara'jad/1/9/9
|only Daggerfall Covenant
step
goto 43.66,17.06 |q Another Omen/Meet Abbot Durak at Shinji's Scarp |tip Leave this building.
|only Daggerfall Covenant
step
...
'Collect Ogre Teeth |q Ogre Teeth/.*Collect Ogre Teeth.*
step
goto 71.12,38.72
|tip Persuade him.
...
step
'Open Stormhaven Map
'Travel to Wayrest in Stormhaven |q Azura's Aid/Talk to Abbot Durak
|tip Manually skip to the next step.
step
...
step
goto 24.92,32.77 |q Shornhelm Divided/Weaken Montclair's Control |tip Leave this building.
step
goto 20.95,36.79
|tip Inside the building.
...
step
goto 25.87,66.14
'Use _Tamrith Camp_ Wayshrine
'Travel to _Shornhelm_ Wayshrine |q The Concealing Veil/Talk to Verandis at Lorkrata Hills
|tip Manually skip to the next step.
step
...
step
goto 66.12,67.64
'Use _Sanguine Barrows_ Wayshrine
'Travel to _Hoarfrost Downs_ Wayshrine |q The Concealing Veil/Talk to Verandis at Lorkrata Hills
|tip Manually skip to the next step.
step
goto 60.35,47.59
...
step
goto 60.77,41.82
|tip Upstairs and inside the crumbled tower.
...
wayshrine Bergama
step
goto 64.01,58.10 |q Proving the Deed/Meet Aelif to Travel to Ragnthar
|only Daggerfall Covenant
step
goto 63.29,59.58
talk Aelif |q Proving the Deed/Meet Aelif to Travel to Ragnthar
...
step
goto 84.98,33.97 |q Imperial Incursion/Find Magnifico Khorshad's Manor |tip Leave this building.
step
goto 84.96,33.42
...
step
'Use _Viridian Woods_ Wayshrine
...
'Use _Eastern Evermore_ Wayshrine
'Travel to _Viridian Woods_ Wayshrine |q Rendezvous at the Pass/Talk to Scout Nadira
|tip Manually skip to the next step.
step
...
step
goto 33.27,54.90
'Use _Sunken Road_ Wayshrine
'Travel to _Bangkorai Pass_ Wayshrine |q Storming the Garrison |future
|tip Manually skip to the next step.
step
goto 47.12,54.93
talk High King Emeric
...
step
goto 55.84,64.66 |q Hallin's Burden |future
step
...
step
goto 56.95,28.93
'Open Hallin's Stand |q Hallin's Burden |future
|tip Manually skip to the next step.
step
goto 56.15,28.90
talk Ayma
...
step
goto 37.86,86.56 |q Striking Back/Travel to the Hall of Heroes
step
goto 40.74,83.71
...
'Travel to _Bleakrock_ Wayshrine |q The Frozen Man |future
|tip Manually skip to the next step.
step
goto 49.08,22.77
talk Rolunda
...
step
'Open Bleakrock Isle Map
'Travel to _Bleakrock_ Wayshrine |q The Missing of Bleakrock/Find Missing Villagers
|tip Manually skip to the next step.
step
...
'Travel to _Dhalmora_ Wayshrine |q If By Sea/Return to Dhalmora
|tip Manually skip to the next step.
step
...
'Use _Dhalmora_ Wayshrine
'Travel to _Fort Zeren_ Wayshrine |q Crossroads/Help Darj at the Fort
|tip Manually skip to the next step.
step
...
|only Ebonheart Pact
step
goto 68.23,54.30 |q Legacy of the Ancestors/Meet Holgunn |tip Leave the mages guild.
|only Ebonheart Pact
step
goto 60.60,32.73
...
'Travel to _The Harborage_ in Stonefalls |q Long Lost Lore/Enter the Ruins
|tip Manually skip to the next step.
|only Ebonheart Pact
step
...
'Travel to _Othrenis_ in Stonefalls |q Anchors from the Harbour/Find Merric and Aelif
|tip Manually skip to the next step.
|only Ebonheart Pact
step
...
step
'Open Stonefalls Map
'Travel to _Hrogar's Hold_ Wayshrine |q To Fort Virak/Talk to Sergeant Gjorring
|tip Manually skip to the next step.
|only Ebonheart Pact
step
...
step
'Open Stonefalls Map
'Travel to _Fort Virak_ Wayshrine |q City at the Spire/Travel to Kragenmoor
|tip Manually skip to the next step.
step
...
step
'Open Stonefalls Map
'Travel to Kragenmoor in Stonefalls |q Aggressive Negotiations/Talk to Denu Faren
|tip Manually skip to the next step.
|only Ebonheart Pact
step
...
step
goto 50.66,51.36
'Use _Kragenmoor_ Wayshrine
'Travel to _Ashen Road_ Wayshrine |q To the Tormented Spire/Travel to Tormented Spire
|tip Manually skip to the next step.
step
...
step
goto deshaan_base 12.64,51.37 |q For Their Own Protection |future
step
goto 11.79,56.52
...
step
goto 26.98,54.94
'Use _Muth Gnaar Hills_ Wayshrine
'Travel to _West Narsis_ Wayshrine |q For Their Own Protection |future
|tip Manually skip to the next step.
step
...
|only Ebonheart Pact
step
goto 48.73,67.65 |q A Favor Returned/Talk to Naryu Virian
|only not Ebonheart Pact
step
goto 76.97,56.84
|tip Inside this building.
...
step
goto 52.84,42.66 |q Chasing the Magistrix/Follow Vox to Selfora
step
...
'Travel to _Mournhold_ Wayshrine |q Chasing the Magistrix/Follow Vox to Selfora
|tip Manually skip to the next step.
step
...
step
'Open Deshaan Map
'Travel to _Ghost Snake Vale_ Wayshrine |q Chasing the Magistrix/Follow Vox to Selfora
|tip Manually skip to the next step.
|only Ebonheart Pact
step
...
step
goto deshaan_base 39.15,58.49 |q Onward to Shadowfen/Find the Shadowfen Border |future
step
goto 38.75,61.96
lorebook The Dreamstride/1/8/3
|only Ebonheart Pact
...
step
'Use _Hatching Pools_ Wayshrine
...
step
'Use _Venomous Fens_ Wayshrine in Shadowfen
'Travel to _Stormhold_ Wayshrine |q The Mnemic Egg/Travel to Loriasel
|tip Manually skip to the next step.
step
...
'Travel to _Hatching Pools_ Wayshrine |q The Mnemic Egg/Travel to Loriasel
|tip Manually skip to the next step.
step
goto 44.05,72.34
wayshrine Hissmir
...
'Rescue Kazdi |q The Dominion's Alchemist/Find Ruuvitar
|tip Manually skip to the next step.
step
...
step
goto 39.58,66.28
talk Kazdi |q The Dominion's Alchemist/Find a Way into the Inner Bailey |future
|tip Manually skip to the next step.
step
goto 39.34,69.02
...
'Travel to _Windhelm_ Wayshrine |q Windhelm's Champion/Talk to Mera Stormcloak
|tip Manually skip to the next step.
step
...
'Travel to _Fort Morvunskar_ in Eastmarch |q Victory at Morvunskar/Talk to Thane Oda at Fort Amol
|tip Manually skip to the next step.
|only Ebonheart Pact
step
...
step
goto 24.73,43.34
'Use _Cradlecrush_ Wayshrine
'Travel to _Fort Morvunskar_ Wayshrine |q Victory at Morvunskar/Talk to Thane Oda at Fort Amol
|tip Manually skip to the next step.
step
...
step
goto 65.11,26.25
'Open The Rift |q To Honrich Tower/Reach Honrich Tower
|tip Manually skip to the next step.
step
...
step
'Open The Rift Map
'Travel to Honrich Tower |q A Giant in Smokefrost Peaks/Talk to Captain Viveka
|tip Manually skip to the next step.
step
goto 61.17,45.57
...
accept To the King
step
goto 56.53,71.78 |q To the King/Talk to Jorunn the Skald-King
step
...
'Travel to _Riften_ Wayshrine |q Will of the Council/Talk to Aelif
|tip Manually skip to the next step.
|only Ebonheart Pact
step
...
step
goto 38.58,55.45
'Use _Shrouded Plains_ Wayshrine
'Travel to _Moonless Walk_ Wayshrine |q Into the Woods/Talk to Sergeant Kamu
|tip Manually skip to the next step.
step
goto 22.94,66.28
...
'Travel to _Reaver Citadel_ Wayshrine |q The Citadel Must Fall |future
|tip Manually skip to the next step.
step
goto 51.83,41.93
talk King Laloriaran Dynar
...
step
goto 28.84,49.02 |q The Warrior's Call/Meet Titus In the Tombs of the Na-Totambu
step
...
step
goto 12.15,62.07
'Open Craglorn |q Elemental Army/Defeat the Flame Monarch
|tip Manually skip to the next step.
step
...
step
goto 48.59,85.33
'Open Cavern |q Elemental Army/Find Kelmen Locke at Ritual Site
|tip Manually skip to the next step.
step
goto 77.59,56.56 |q Elemental Army/Find Kelmen Locke at Ritual Site
step
goto 84.30,14.26
'Open Craglorn |q Elemental Army/Find Kelmen Locke at Ritual Site
|tip Manually skip to the next step.
step
...
'Open Fearfangs Cavern |q Slithering Brood/.*Destroy the Scorpion Nests.* |count 1
|tip Manually skip to the next step.
step
...
step
goto 58.27,42.70
'Open Ilthag's Undertower |q The Serpent's Fang/Meet Little Leaf in Ilthag's Undertower |future
|tip Manually skip to the next step.
step
...
step
goto 65.93,59.46
'Open Chambers of Loyalty |q The Anger of a King/Rendezvous with Eveli Sharp-Arrow
|tip Manually skip to the next step.
step
goto 58.22,73.09 |q The Anger of a King/Rendezvous with Eveli Sharp-Arrow
step
goto 29.90,72.77
'Open Waiting Chambers |q The Anger of a King/Rendezvous with Eveli Sharp-Arrow
|tip Manually skip to the next step.
step
goto 23.09,95.34
...
'Open Wayrest Outlaws Refuge |q Partners in Crime |future
|tip Manually skip to the next step.
|only Daggerfall Covenant
step
...
step
goto 27.16,88.34
'Open Wayrest |q Partners in Crime/Meet Quen at the Wayrest Docks
|tip Manually skip to the next step.
|only Daggerfall Covenant
step
...
'Open Windhelm Outlaws Refuge |q Partners in Crime |future
|tip Manually skip to the next step.
|only Ebonheart Pact
step
...
step
goto 91.35,49.77
'Open Windhelm |q Partners in Crime/Meet Quen at the Windhelm Docks
|tip Manually skip to the next step.
|only Ebonheart Pact
step
...
step
goto 83.60,48.91
'Travel Fulstrom Homestead |q Partners in Crime/Approach Fulstrom Homestead |future
|only Ebonheart Pact
|tip Manually skip to the next step.
step
...
'Unlock Fulstrom Manor |q Partners in Crime/Enter Fulstrom Manor
step
...
step
'Open Hew's Bane Map
'Travel _Abah's Landing_ in Hew's Bane |q Cleaning House/Return Silver-Claw's Ledger |future
|tip Manually skip to the next step.
step
goto 21.38,43.10
...
step
goto 55.97,71.71
'Use Hiding Spot |q The Long Game/Eavesdrop on Captain Evani |tip Go up the stairs.
step
goto 40.78,49.18
|tip Go up the stairs.
...
'Open Dead Wolf Inn |q The One That Got Away/Find the Desert Falcon in Shornhelm
|only Daggerfall Covenant
step
goto 47.82,61.33
talk Rhanbiq |q The One That Got Away/Talk to Rhanbiq
...
'Open Shornhelm Outlaws Refuge |q The One That Got Away/Find Bellulor Chatterbeak in the Shornhelm Outlaws Refuge |future
|tip Manually skip to the next step.
|only Daggerfall Covenant
step
...
step
goto 49.30,32.20
'Open Manor Garden |q The One That Got Away/Find Nicolas in the Alik'r Desert
|tip Manually skip to the next step.
|only Daggerfall Covenant
step
goto 49.30,31.87
...
'Open Coin Brothers' Cornerclub |q The One That Got Away/Find the Desert Falcon in Stormhold
|only Ebonheart Pact
step
goto 35.09,29.25
talk Rhanbiq |q The One That Got Away/Talk to Rhanbiq
...
step
goto 60.40,16.52
'Open Stormhold Outlaws Refuge |q The One That Got Away/Find Bellulor Chatterbeak in the Stormhold Outlaws Refuge
|tip Manually skip to the next step.
|only Ebonheart Pact
step
...
step
goto 92.56,51.47
'Open Manor Garden |q The One That Got Away/Find Nicolas in Deshaan
|tip Manually skip to the next step.
|only Ebonheart Pact
step
goto 93.09,51.52
...
'Open Anvil Lighthouse |q Signed in Blood/Report to Speaker Terenus |future
|tip Manually skip to the next step.
step
goto 23.57,68.84
...
step
goto 46.65,39.49
|tip If quest not available leave the room and come back.
...
step
goto 26.81,82.60
'Burn Red Sails Crew Pardons |q Dark Revelations/Burn the Pardon
|tip Manually skip to the next step.
step
...
goto 77.64,79.13
|tip Watch dialogue
'Examine The Black Dragon's Journal |q Dark Revelations/Search the Black Dragon's Chamber
step
'Open Gold Coast Map
